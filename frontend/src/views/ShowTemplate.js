...
const ShowTemplate=({ match, location, history })=>{
              ...
              <Card.Body>
                <Row>
                  ...
                  <Col md="4">
                      ...
                      <h6 className="card-category"><b>View Current Template</b></h6>
                      <Card.Title as="h4">
                      <Button color="primary" onClick={func}>View Template</Button>
                      </Card.Title>
